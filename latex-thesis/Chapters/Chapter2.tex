...
\cite{dougherty1997short} applied a backpropagation feedforward neural network in traffic flow
...
\ref{table:comparisonExistingMethods}.

\begin{table}
\centering
    \begin{tabular}{ l p{5cm} p{5cm} p{5cm}} \hline
       \textbf{Model} & Data requirements & Advantages & Disadvantages\\ \hline
       Smoothing &  &  &  \\ \hline
       ARIMA &  &  &  \\ \hline
